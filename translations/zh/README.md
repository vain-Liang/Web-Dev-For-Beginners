...
| :-: | :--------------------------------------------------: | :----------------------------------------------------------------: | ----------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------: | :-------------------: |
| 01  |                     入门课程                      |           编程简介及开发工具           | 学习大多数编程语言的基本原理以及帮助专业开发者完成工作的相关软件 | [编程语言简介及开发工具](translations/zh/1-getting-started-lessons/1-intro-to-programming-languages/README.md) |         Jasmine         |
| 02  |                     入门课程                      |             GitHub 基础知识，包括团队协作             | 学习如何在项目中使用 GitHub，以及如何与他人协作开发代码库                                                    |                            [GitHub 简介](translations/zh/1-getting-started-lessons/2-github-basics/README.md)                             |          Floor          |
| 03  |                     入门课程                      |                             无障碍访问                              | 学习网页无障碍访问的基础知识                                                                                               |                       [无障碍访问基础](translations/zh/1-getting-started-lessons/3-accessibility/README.md)                       |       Christopher       |
| 04  |                        JS 基础                         |                         JavaScript 数据类型                          | JavaScript 数据类型的基础知识                                                                                                 |                                       [数据类型](translations/zh/2-js-basics/1-data-types/README.md)                                        |         Jasmine         |
| 05  |                        JS 基础                         |                         函数和方法                          | 学习如何使用函数和方法来管理应用程序的逻辑流                                                             |                              [函数和方法](translations/zh/2-js-basics/2-functions-methods/README.md)                               | Jasmine 和 Christopher |
| 06  |                        JS 基础                         |                        使用 JS 做决策                        | 学习如何使用决策方法在代码中创建条件                                                           |                                 [做决策](translations/zh/2-js-basics/3-making-decisions/README.md)                                  |         Jasmine         |
| 07  |                        JS 基础                         |                            数组和循环                            | 使用 JavaScript 中的数组和循环处理数据                                                                                 |                                   [数组和循环](translations/zh/2-js-basics/4-arrays-loops/README.md)                                    |         Jasmine         |
| 08  |       [生态瓶](translations/zh/3-terrarium/solution/README.md)       |                            HTML 实践                            | 构建 HTML 创建在线生态瓶，重点是布局构建                                                         |                                 [HTML 简介](translations/zh/3-terrarium/1-intro-to-html/README.md)                                 |           Jen           |
| 09  |       [生态瓶](translations/zh/3-terrarium/solution/README.md)       |                            CSS 实践                             | 构建 CSS 样式化在线生态瓶，重点是 CSS 基础知识，包括使页面响应式                     |                                  [CSS 简介](translations/zh/3-terrarium/2-intro-to-css/README.md)                                  |           Jen           |
| 10  |            [生态瓶](translations/zh/3-terrarium/solution/README.md)            |                 JavaScript 闭包和 DOM 操作                  | 构建 JavaScript 使生态瓶具备拖放界面功能，重点是闭包和 DOM 操作             |                  [JavaScript 闭包和 DOM 操作](translations/zh/3-terrarium/3-intro-to-DOM-and-closures/README.md)                   |           Jen           |
| 11  |          [打字游戏](translations/zh/4-typing-game/solution/README.md)          |                          构建打字游戏                           | 学习如何使用键盘事件驱动 JavaScript 应用的逻辑                                                          |                                [事件驱动编程](translations/zh/4-typing-game/typing-game/README.md)                                |       Christopher       |
| 12  | [绿色浏览器扩展](translations/zh/5-browser-extension/solution/README.md) |                         浏览器相关知识                          | 学习浏览器的工作原理、历史，以及如何搭建浏览器扩展的初始元素                               |                               [关于浏览器](translations/zh/5-browser-extension/1-about-browsers/README.md)                                |           Jen           |
| 13  | [绿色浏览器扩展](translations/zh/5-browser-extension/solution/README.md) | 构建表单、调用 API 并将变量存储在本地存储中 | 构建浏览器扩展的 JavaScript 元素，通过存储在本地存储中的变量调用 API                      |                [API、表单和本地存储](translations/zh/5-browser-extension/2-forms-browsers-local-storage/README.md)                 |           Jen           |
| 14  | [绿色浏览器扩展](translations/zh/5-browser-extension/solution/README.md) |          浏览器后台进程和网页性能          | 使用浏览器的后台进程管理扩展图标；学习网页性能及一些优化方法   |             [后台任务和性能](translations/zh/5-browser-extension/3-background-tasks-and-performance/README.md)              |           Jen           |
| 15  |           [太空游戏](translations/zh/6-space-game/solution/README.md)           |             更高级的 JavaScript 游戏开发             | 学习使用类和组合进行继承以及发布/订阅模式，为构建游戏做准备              |                      [高级游戏开发简介](translations/zh/6-space-game/1-introduction/README.md)                       |          Chris          |
| 16  |           [太空游戏](translations/zh/6-space-game/solution/README.md)           |                           绘制到画布                            | 学习 Canvas API，用于将元素绘制到屏幕                                                                       |                                [绘制到画布](translations/zh/6-space-game/2-drawing-to-canvas/README.md)                                |          Chris          |
| 17  |           [太空游戏](translations/zh/6-space-game/solution/README.md)           |                   在屏幕上移动元素                    | 探索如何使用笛卡尔坐标和 Canvas API 使元素获得运动                                            |                           [移动元素](translations/zh/6-space-game/3-moving-elements-around/README.md)                           |          Chris          |
| 18  |           [太空游戏](translations/zh/6-space-game/solution/README.md)           |                          碰撞检测                           | 使元素碰撞并对彼此做出反应，使用按键提供冷却功能以确保游戏性能    |                              [碰撞检测](translations/zh/6-space-game/4-collision-detection/README.md)                              |          Chris          |
| 19  |           [太空游戏](translations/zh/6-space-game/solution/README.md)           |                             计分                              | 根据游戏状态和表现进行数学计算                                                                |                                    [计分](translations/zh/6-space-game/5-keeping-score/README.md)                                    |          Chris          |
| 20  |           [太空游戏](translations/zh/6-space-game/solution/README.md)           |                     结束和重新开始游戏                     | 学习如何结束和重新开始游戏，包括清理资源和重置变量值                              |                                [结束条件](translations/zh/6-space-game/6-end-condition/README.md)                                 |          Chris          |
| 21  |         [银行应用](translations/zh/7-bank-project/solution/README.md)          |                 HTML 模板和网页应用中的路由                 | 学习如何使用路由和 HTML 模板创建多页面网站的架构                             |                            [HTML 模板和路由](translations/zh/7-bank-project/1-template-route/README.md)                             |          Yohan          |
| 22  |         [银行应用](translations/zh/7-bank-project/solution/README.md)          |                  构建登录和注册表单                   | 学习如何构建表单并处理验证逻辑                                                                          |                                           [表单](translations/zh/7-bank-project/2-forms/README.md)                                           |          Yohan          |
| 23  |         [银行应用](translations/zh/7-bank-project/solution/README.md)          |                   数据获取和使用方法                   | 学习数据如何在应用中流动，如何获取、存储和处理数据                                                 |                                            [数据](translations/zh/7-bank-project/3-data/README.md)                                            |          Yohan          |
| 24  |         [银行应用](translations/zh/7-bank-project/solution/README.md)          |                      状态管理概念                      | 学习应用如何保持状态以及如何通过编程管理状态                                                              |                                [状态管理](translations/zh/7-bank-project/4-state-management/README.md)                                |          Yohan          |
| 25 | [浏览器/VS Code 编辑器](translations/zh/8-code-editor) | 使用 VS Code | 学习如何使用代码编辑器 | [使用 VS Code 编辑器](translations/zh/8-code-editor/1-using-a-code-editor/README.md) | Chris |
| 26 | [AI 助手](translations/zh/9-chat-project/README.md) | 使用 AI | 学习如何构建自己的 AI 助手 | [AI 助手项目](translations/zh/9-chat-project/README.md) | Chris |
